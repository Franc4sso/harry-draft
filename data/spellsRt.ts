...
export const SPELLS_RT: SpellRt[] = [
  ...
  S({ id: 'sectumsempra', name: 'Sectumsempra', desc: 'Taglio oscuro che lascia Vulnerabile. Memoria: +1 danno per vittoria.', verb: 'danno', potenza: 2.4, keywords: ['magieOscure'], teamStatus: { kind: 'vulnerabile', secondi: 2 }, crescita: { kind: 'memoria', trigger: 'vittoria', per: 1, unit: 'danno' } }),
