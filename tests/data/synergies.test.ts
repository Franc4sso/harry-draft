...
describe('synergies data', () => {
  it('contiene solo sinergie di archetipo (tossicita, spietatezza, bastione), nessuna sinergia di squadra tradizionale', () => {
    ...
    // è stata riaccesa allo stesso modo (2026-07-23, Task 1 del piano Muro) come terza
    // sinergia di archetipo — non è una regressione, è la nuova verità.
